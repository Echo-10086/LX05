...
namespace DAL
{
    public class Activity
    {
        ...
        public Model.Activity ActivityGetEnd()
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
        ...
        public IEnumerable<Model.ActivityName> GetActivityNames()
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "select activityId,activityName from acyivity";
        ...
        public int UpdateRecommend(Model.Activity activity)
        {
            using (IDbConnection cn = new MySqlConnection (cns))
            {
                string sql = "update actvity set recommend=@recommend,recommendTime=@recommendTime where activityid=@activityId";
